...
| Notebook | Topic |
|----------|-------|
| [01_hh_theory.ipynb](01_hh_theory.ipynb) | HH model derivation, gating variables, action potential |
| [02_hh_gpu_solver.ipynb](02_hh_gpu_solver.ipynb) | Euler and RK4 solvers on GPU |
| [03_parameter_sweep.ipynb](03_parameter_sweep.ipynb) | Parallel parameter exploration |

## Exercises

| File | Description |
|------|-------------|
| [exercises/ex04_stub.ipynb](exercises/ex04_stub.ipynb) | Add a potassium A-current (I_A) to the model |
| [exercises/ex04_solution.ipynb](exercises/ex04_solution.ipynb) | Complete solution |
